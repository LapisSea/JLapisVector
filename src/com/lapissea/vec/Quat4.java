...
//	}
	...
	public Quat4(@NotNull Quat4 quat){
...
//	}
	...
	@NotNull
	@Override
	public Quat4 interpolate(@NotNull Quat4 second, float percent){
		return interpolate(this, this, second, percent);
	}
	
	@NotNull
	@Override
	public Quat4 interpolate(@NotNull Quat4 first, @NotNull Quat4 second, float percent){
